...
const aType_enum_1 = require("../entities/aType.enum");
...
], CreateAccountDto.prototype, "current_balance", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
], CreateAccountDto.prototype, "created_at", void 0);
__decorate([
    (0, class_validator_1.IsDate)(),
    __metadata("design:type", Date)
], CreateAccountDto.prototype, "updated_at", void 0);
