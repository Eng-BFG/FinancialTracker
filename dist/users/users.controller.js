...
let UsersController = class UsersController {
    ...
    create(id, role_id, createUserDto) {
...
__decorate([
    (0, common_1.Post)('/createUser/company/:id/role/:role_id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('role_id', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, create_user_dto_1.CreateUserDto]),
